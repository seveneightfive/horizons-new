...
const ArtistDetail = () => {
    ...
    const { getArtistBySlug, getEventsByArtistId, getReviewsByArtistId } = useDashboardData();
    ...
    useEffect(() => {
        ...
        if (artistData) {
            ...
            if (artistData.type === 'Band' && artistData.featuredSong) {
                setCurrentSong({ url: artistData.featuredSong, title: `Featured Song by ${artistData.name}` });
            }
        }
